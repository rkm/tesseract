...
namespace Tesseract
{
	public unsafe class PixData
	{
		...
		{		
            Pix = pix;
            Data = LeptonicaApiSignatures.pixGetData(Pix.Handle);
            WordsPerLine = LeptonicaApiSignatures.pixGetWpl(Pix.Handle);
		}
        ...
        {
            LeptonicaApiSignatures.pixEndianByteSwap(Pix.Handle);
        }
